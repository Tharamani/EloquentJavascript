...
// ([76, 9, 4, 1]) or ([[76, 9], [4, 1]])

// interpret the indices to the array as two-bit binary numbers, where the leftmost (most significant) digit refers to the squirrel variable and the rightmost (least significant) digit refers to the event variable.
function phi(table) {
...
function tableFor(event, journal) {
	...
	for (let i = 0; i < journal.length; i++) {
		...
		table[index] += 1;
		console.log('event', entry.events.includes(event));
