...
console.log(characterScript(10240));

//
let horseShoe = '🐴👟';
console.log(horseShoe.length); // 4
console.log(horseShoe[0]); // � (Invalid half-character)
console.log(horseShoe[1]); // � (Invalid half-character)
// JavaScript’s charCodeAt method gives you a code unit,
...
console.log(horseShoe.codePointAt(1)); // 56372 (Actual code for shoe emoji)
